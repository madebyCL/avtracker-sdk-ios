...
final public class AvTracker: NSObject {
    ...
    internal static var _sharedInstance: AvTracker?
    ...
    @objc convenience public init(siteId: String, baseURL: URL, userAgent: String? = nil) {
        ...
        let dispatcher = URLSessionDispatcher(baseURL: URL(string: "https://ad-v.kr/p")!, userAgent: userAgent)
    ...
    @objc public func dispatch() {
        guard !isDispatching else {
            logger.verbose("AvTracker is already dispatching.")
            return
        }
